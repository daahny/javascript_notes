...
// Great examples from https://www.w3schools.com/js/js_async.asp
async function aaConcurrency2() {
...
async function aaConcurrency3() {
    let prom1 = new Promise((resolve, reject) => {
        setTimeout(() => resolve("resolved!"), 3000);
    });

    await prom1;
    console.log(`This will only be logged if prom2 is finished! prom2: ${prom2}`);
}




// An additional example from Mozilla developer docs: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function
